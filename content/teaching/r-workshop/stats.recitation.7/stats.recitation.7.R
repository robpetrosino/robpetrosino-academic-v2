...
_______________________ <- starwarsSelect %>%
...
___________ <- exam1.data %>%
  pivot_longer(cols = __________, # indicate the columns to pivot into longer format, that is "grammatical" and "ungrammatical"
               names_to = ___________, # name of the column with the levels of the group
               values_to = __________) # name of the column with the actual values

## Let's change it back!

__________ <- __________ %>%
  pivot_wider(names_from = __________ # name of the column to get the names from and transform into columns
              values_from = __________) # name of the column to get the values from
